...
namespace DataTransferModels.BlogArticle.Request
{
    ...
    {
        public RequestCreateBlogArticleDto(string userId, string articleTitle, string articleConten, bool isValid, DateTime createTime,string actionUserInfo,string actionUsername)
        {
            UserId = userId;
