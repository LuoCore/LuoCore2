...
namespace Services
{
    public class UserBasisService : SqlSugarRepository<ISystemLogsRepository, IUserRepository, IPermissionRepository, IRoleRepository, IRolePermissionRepository, IUserRoleRepository>, IUserBasisService
    {
        public UserBasisService(ISqlSugarFactory factory, ISystemLogsRepository repository, IUserRepository repository2, IPermissionRepository repository3, IRoleRepository repository4, IRolePermissionRepository repository5, IUserRoleRepository repository6) : base(factory, repository, repository2, repository3, repository4, repository5, repository6)
        {
        }
        ...
        public Task<ViewModels.Layui.TableVm> GetPermissionTable(RequestGetPermissionVm req)
        {
            ...
            List<ViewModels.UserBasis.Response.ResponsePermissionTableVm> resData = new List<ViewModels.UserBasis.Response.ResponsePermissionTableVm>();
            foreach (var item in result.Data.TableData)
            {
                ...
                resData.Add(new ViewModels.UserBasis.Response.ResponsePermissionTableVm()
                {
