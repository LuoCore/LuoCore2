...
namespace Utility
{
    public class VerificationCode
    {
        ...
        public string CheckCode
        {
            get
            {
                if (string.IsNullOrWhiteSpace(_checkCode))
                {

                    switch (_codetype)
                    {
                        case CodeType.字母:
                            _checkCode = GenerateAlphas();
                            break;
                        case CodeType.数字:
                            _checkCode = GenerateNumbers();
                            break;
                        case CodeType.字母数字:
                            _checkCode = GenerateCharacters();
                            break;
                        default:
                            _checkCode = GenerateAlphas();
                            break;
        ...
        #region Public Field
        public enum CodeType { 字母, 数字, 字母数字, Alphas }
        #endregion
